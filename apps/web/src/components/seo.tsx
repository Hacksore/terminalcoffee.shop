...
export const SEO = ({
  ...
  return (
    <Head>
      ...
      <meta property="og:image:alt" content="Terminal Coffee Shop - Order Coffee Online" />
      ...
      <meta name="twitter:image:alt" content="Terminal Coffee Shop - Order Coffee Online" />
